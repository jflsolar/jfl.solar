...
import { GridTiedPackagesData } from "@/constants/cardData";
interface Props {
  type: "DIY" | "Installation";
}
const GridTiedPackages = ({ type }: Props) => {
  return (
